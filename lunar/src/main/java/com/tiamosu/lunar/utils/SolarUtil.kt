...
object SolarUtil {
    ...
    /** 每月天数  */
    val DAYS_OF_MONTH = intArrayOf(31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31)
    ...
    /** 日期对应的节日  */
    val FESTIVAL = HashMap<String, String>().apply {
        put("1-1", "元旦节")
        put("2-14", "情人节")
        put("3-8", "妇女节")
        put("3-12", "植树节")
    ...
    /** 几月第几个星期几对应的节日  */
    val WEEK_FESTIVAL = HashMap<String, String>().apply {
        put("5-2-0", "母亲节")
        put("6-3-0", "父亲节")
        put("11-4-4", "感恩节")
    }
    ...
    /** 日期对应的非正式节日  */
    val OTHER_FESTIVAL = HashMap<String, List<String>>().apply {
